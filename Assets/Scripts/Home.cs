...
public class Home : MonoBehaviour {
	...
	public void OnRecordButtonClicked() {
		...
		Image recordImage = gameObject.GetComponent<Image> ();
		if (!app.RtcEngine.IsScreenRecording ()) {
			audioSource.Play ();
			recordImage.sprite = (Sprite)Resources.Load ("stopRecord", typeof(Sprite));
			app.RtcEngine.StartRecordScreen ();
		} else {
			app.RtcEngine.StopRecordScreen ();
			audioSource.Stop ();
			recordImage.sprite = (Sprite)Resources.Load ("startRecord", typeof(Sprite));
		}
	}
