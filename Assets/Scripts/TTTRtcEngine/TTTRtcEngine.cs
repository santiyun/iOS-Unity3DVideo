...
namespace TTTRtcEngine
{
	...
	#region DllImport
		...
		[DllImport (MyLibName, CharSet = CharSet.Ansi)]
		private static extern bool isScreenRecording();
		[DllImport (MyLibName, CharSet = CharSet.Ansi)]
		private static extern int startRecordScreen();
		[DllImport (MyLibName, CharSet = CharSet.Ansi)]
		private static extern int stopRecordScreen();
	#endregion // DllImport
	...
	#region Engine callbacks
		...
		*/
		...
		public int StartRecordScreen() {
			return startRecordScreen ();
		}
